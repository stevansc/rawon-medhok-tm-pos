...
# --- CATEGORIES ---
@app.get("/categories", response_model=List[schemas.MenuCategoryResponse])
...
@app.post("/orders/{order_id}/items/{item_id}/decline")
...
# --- ADMIN DASHBOARD ---
@app.get("/admin/dish-performance", response_model=List[schemas.DishPerformanceResponse])
